        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Notre Scène, C'est la Cuisine</h2>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">La Philosophie du « Dekinitate »</h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">L'« Inefficacité » Volontaire au Service de l'Excellence</h3>
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 mt-8">Le Défi du « Ritsuryō Ryōritsu »</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Les Artisans : Men-Shokunin</h2>
            </div>

            <div className="prose prose-lg max-w-none">
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Au-delà du Simple Personnel : Les Maîtres de l'Udon</h3>
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4 mt-8">La Maîtrise au Quotidien</h3>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Histoire et Évolution</h2>
            </div>
                ...
                <div className="bg-white rounded-lg shadow-sm p-6">
                  ...
                  <div className="space-y-3 text-sm">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span>Self-service premium</span>
                    </div>
                  </div>
                </div>
