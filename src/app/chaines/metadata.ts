...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Découvrez toutes les chaînes de restaurants japonais avec notre guide complet. 46 chaînes référencées avec menus, prix et conseils de commande pour voyageurs francophones.',
    keywords: [
      ...
      'yakiniku premium', 'hasami-deru kalbi',
    ...
    openGraph: {
      ...
      description: 'Guide complet de 46 chaînes de restaurants japonais avec menus et conseils pratiques',
      type: 'website',
      url: '/chaines',
    },
    twitter: {
      ...
      title: 'Toutes les Chaînes de Restaurants Japonais',
      description: 'Guide complet de 46 chaînes de restaurants japonais',
    },
    alternates: {
      canonical: '/chaines',
    },
