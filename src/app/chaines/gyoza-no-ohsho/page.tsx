...
import { ArrowLeft, Clock, MapPin, CreditCard, Info, Star, TrendingUp, Users, History, Award, Utensils, Crown, Flame, ChefHat } from 'lucide-react';

export default function GyozaNoOhshoPage() {  return (
