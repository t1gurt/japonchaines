      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h5 className="font-semibold mb-4">Plats Chinois</h5>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><span className="hover:text-white">Gyoza</span></li>
                <li><span className="hover:text-white">Fried Rice</span></li>
                <li><span className="hover:text-white">Sweet & Sour Pork</span></li>
                <li><span className="hover:text-white">Chanpon</span></li>
              </ul>
            </div>
            <div>
              <h5 className="font-semibold mb-4">Chaînes Chinoises</h5>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/chaines/bamiyan" className="hover:text-white">Bamiyan</Link></li>
                <li><Link href="/chaines/ohsho" className="hover:text-white">Gyoza no Ohsho</Link></li>
                <li><Link href="/chaines/ringer-hut" className="hover:text-white">Ringer Hut</Link></li>
              </ul>
            </div>
            <div>
