      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              <h5 className="font-semibold mb-4">Types de Curry</h5>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><span className="hover:text-white">Katsu Curry</span></li>
                <li><span className="hover:text-white">Chicken Curry</span></li>
                <li><span className="hover:text-white">Vegetable Curry</span></li>
                <li><span className="hover:text-white">Seafood Curry</span></li>
              </ul>
            </div>
            <div>
              <h5 className="font-semibold mb-4">Chaînes Curry</h5>
              <ul className="space-y-2 text-sm text-gray-400">
                <li><Link href="/chaines/coco-ichibanya" className="hover:text-white">CoCo壱番屋</Link></li>
                <li><Link href="/chaines/go-go-curry" className="hover:text-white">Go!Go!Curry</Link></li>
                <li><Link href="/chaines/sukiya" className="hover:text-white">Sukiya Curry</Link></li>
              </ul>
            </div>
            <div>
