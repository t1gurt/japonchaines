        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-3xl font-bold text-gray-900">Le Créateur</h2>
            </div>

            <div className="flex flex-col md:flex-row gap-8 items-start">
              <div className="flex-1">
                <h3 className="text-xl font-bold text-gray-900 mb-2">Tigurt</h3>
                <p className="text-red-600 font-medium mb-4">Fondateur & Explorateur Culinaire</p>

                <div className="prose prose-lg text-gray-700">
                  <p className="mb-4">
                    Japonais, la quarantaine, j'apprends le français avec passion.
                  </p>
                  <p className="mb-4">
                    Mon objectif est de vous faire profiter de la culture culinaire japonaise en toute simplicité.
                    Les chaînes de restaurants constituent le socle de cette culture au quotidien.
                    Je crois que les connaître est une première étape idéale pour vous donner la confiance nécessaire
                    de pousser la porte des restaurants au Japon.
                  </p>
                  <p>
                    En tant que local, j'ai fréquenté d'innombrables établissements au fil des années,
                    et je souhaite partager cette expérience authentique avec vous pour enrichir votre voyage.
                  </p>
                </div>
              </div>
            </div>
